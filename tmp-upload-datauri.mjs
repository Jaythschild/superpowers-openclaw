...
for (const id of ['doxcnVPWsBOs2vUEz8OsaXPobQd','doxcnM8XTZ0QKo2HTSVwyupzoDc']) {
  try { await doc.execute('doc-delete-block', { action:'delete_block', doc_token:docToken, block_id:id }); } catch {}
}
const b64 = fs.readFileSync('D:/openclaw-stack/workspace/images/ai-daily-visual-2026-05-17.png').toString('base64');
