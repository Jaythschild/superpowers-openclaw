...
const contentPath = 'D:/openclaw-stack/workspace/reports/ai-daily-2026-05-17.md';
const content = fs.readFileSync(contentPath, 'utf8');
const writeRes = await doc.execute('doc-write', { action: 'write', doc_token: docToken, content });

const appendRes = await doc.execute('doc-append', {
  action: 'append',
  doc_token: docToken,
  content: '\n\n---\n\n## 相关视觉元素\n\n### 今日影响力图卡\n'
});
...
console.log(JSON.stringify({
  ...
  appendRes: appendRes.details || appendRes,
  ...
  readBack: {
    ...
    preview: (readBack.content || readBack.details?.content || '').slice(0, 500)
  }
}, null, 2));
